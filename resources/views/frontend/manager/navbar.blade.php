...
$category = DB::table('categories')
    ->take(12)
    ->get();
$tintucmoi = DB::table('tintucs')
    ->where('trangthai', $duocduyet)
...
<header class="header--section header--style-3">
        ...
        <div class="container">
            ...
            <div class="float--right float--xs-none text-xs-center">
                ...
                <ul class="header--topbar-social nav hidden-sm hidden-xxs">
                    <li><a href="https://www.facebook.com/profile.php?id=100084937094951"><i class="fa fa-facebook"></i></a></li>
        ...
        <div class="container">
                ...
                <h1 class="h1">
                    <a href="{{ url('/') }}" class="btn-link">
                        <video autoplay loop muted plays-inline width="60%">
                            <source src="{{ url('/frontend') }}/img/KCN (online-video-cutter.com).mp4"
                                style="video/mp4">
                        </video>
            ...
            <div class="header--ad float--right float--sm-none hidden-xs" style="width:60% ;margin-top:60px">
                <a
                    ...
                    <img src="{{ url('/frontend') }}/img/ads-img/728x90_baner1.png" alt="Advertisement">
                </a>
            </div>
            <!-- Header Ad End -->
        </div>
    ...
    <div class="header--navbar navbar bd--color-1 bg--color-0" data-trigger="sticky">
        <div class="container">
            ...
            <form method="POST" action="{{ url('search') }}" class="header--search-form float--right"
                data-form="validate">
                @csrf
        ...
        <div class="news-updates--list" data-marquee="true">
            <ul class="nav">
                @foreach ($tintucmoi as $tintuc)
                    <li>
                        <h3 class="h3"><a
                                href="{{ route('bai-viet', ['slug' => $tintuc->slug]) }}">{{ $tintuc->title }}.</a>
                        </h3>
                    </li>
                @endforeach
            </ul>
