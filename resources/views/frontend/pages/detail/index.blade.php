    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a href="travel.html" class="btn-link">{{ $news->tintucCategory->title }}</a></li>
                ...
                <div class="main--content col-md-8" data-sticky-content="true">
                    <div class="sticky-content-inner">
                        ...
                        <div class="post--item post--single post--title-largest pd--30-0">
                            <div class="post--img">
                                <a href="#" class="thumb"><img src="/uploads/tintuc/{{ $news->hinhanh }}"
                                        alt=""></a>
                                @if (Auth::check())
                                    <form action="{{ route('like') }}" method="POST">
                                        @csrf
                                        <input hidden type="text" name="tin" value="{{ $news->id }}">
                                ...
                                @else
                                    <a href="#" class="icon"><i class="fa fa-heartbeat" aria-hidden="true"></i></a>
                                @endif
                            </div>
                            <div class="post--cats">
                                <ul class="nav">
                                    ...
                                    @endphp
                                    @foreach ($tags as $tag)
                                        <li><a href="{{ url('tag/' . $news->tag) }}">{{ $tag }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                            <div class="post--info">
                                <ul class="nav meta">
                                    @foreach ($users as $u)
                                        ...
                                        @endif
                                    @endforeach
                                    <li><a href="#">{{ $news->ngayduyet }}</a></li>
                                    <li><span><i class="fa fm fa-eye"></i>{{ $news->luotxem }}</span></li>
                                    <li><a href="#"><i
                                                class="fa fm fa-comments-o"></i>{{ $news->tintucComment->count() }}</a>
                                    </li>
                                </ul>
                                <div class="title">
                            ...
                            <ul class="nav row">
                                @foreach ($relatedNews as $relatedNews)
                                    <li class="col-xs-6 ptop--30 pbottom--30">
                                        ...
                                        <div class="post--item">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet', ['slug' => $relatedNews->slug]) }}"
                                                    class="thumb"><img src="/uploads/tintuc/{{ $relatedNews->hinhanh }}"
                                                        alt=""></a>
                                                <div class="post--info">
                                                    <ul class="nav meta">
                                                        @foreach ($users as $u)
                                                            @if ($u->id == $relatedNews->tacgia)
                                                                <li><a href="#">{{ $u->name }}</a>
                                                                </li>
                                                            @endif
                                                        @endforeach
                                                        <li><a href="#">{{ $relatedNews->ngayduyet }}</a></li>
                                                    </ul>
                                                    <div class="title">
                                                        <h3 class="h4"><a
                                                                href="{{ route('bai-viet', ['slug' => $relatedNews->slug]) }}"
                                                                class="btn-link">{{ $relatedNews->title }}</a></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="post--related ptop--30">
                            ...
                            <div class="post--items post--items-2" data-ajax-content="outer">
                                <ul class="nav row" data-ajax-content="inner">
                                    @foreach ($likedNews as $li)
                                        <li class="col-sm-6 pbottom--30">
                                            <!-- Post Item Start -->
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="{{ route('bai-viet', ['slug' => $li->slug]) }}"
                                                        class="thumb"><img src="/uploads/tintuc/{{ $li->hinhanh }}"
                                                            alt=""></a>
                        ...
                        <div class="comment--list pd--30-0">
                            ...
                            <div class="post--items-title">
                                <h2 class="h4">{{ $news->tintucComment->count() }} bình luận</h2>
                            ...
                            <ul class="comment--items nav">
                                @if (isset($firstCommentCheck))
                                    @foreach ($comments as $comments)
                                        <li>
                                            <!-- Comment Item Start -->
                                            <div class="comment--item clearfix">
                                                <div class="comment--img float--left">
                                                    <img src="{{ url('/frontned') }}/img/news-single-img/comment-avatar-02.jpg"
                                                        alt="">
                                                </div>
                                                <div class="comment--info">
                                                    <div class="comment--header clearfix">
                                                        <p class="name">{{ $comments->commentUser->name }}</p>
                                                        <p class="date">{{ $comments->ngaydang }}</p>
                                                        <a href="{{ url('report' . $comments->id) }}" class="reply"><i
                                                                class="fa fa-flag"></i></a>
                                                    </div>
                                                    <div class="comment--content">
                                                        <p>{{ $comments->noidung }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Comment Item End -->
                        ...
                        <div class="comment--form pd--30-0">
                            ...
                            <div class="comment-respond">
                                @if (Auth::check())
                                    <form method="POST"
                                        action="{{ route('binhluan', ['tin' => $news->id, 'user' => Auth::user()->id]) }}"
                                        data-form="validate">
                                        @csrf
                    ...
                    <div class="sticky-content-inner">
                        ...
                        <div class="widget">
                            ...
                            <div class="ad--widget">
                                <a href="https://mwc.com.vn/products/giay-sandal-nu-mwc-nusd--2887?c=N%C3%82U">
                                    <img src="{{ url('/frontend') }}/img/ads-img/300x250_banner_mwc2.jpg" alt="">
                                </a>
                            </div>
                            <!-- Ad Widget End -->
                        </div>
                            ...
                            <div class="list--widget list--widget-1">
                                <div class="list--widget-nav" data-ajax="tab">
                                    <ul class="nav nav-justified">
                                        ...
                                        <li>
                                            <a href="#" data-ajax-action="load_widget_most_watched">Xem nhiều
                                                nhất</a>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        @foreach ($trendingNews as $trendingNews)
                                            <li>
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $trendingNews->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $trendingNews->hinhanh }}"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                @foreach ($users as $u)
                                                                    @if ($u->id == $trendingNews->tacgia)
                                                                        <li><a href="#">{{ $u->name }}</a>
                                                                        </li>
                                                                    @endif
                                                                @endforeach
                                                                <li><a href="#">{{ $trendingNews->ngayduyet }}</a>
                                                                </li>
                                                            </ul>
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $trendingNews->slug]) }}"
                                                                        class="btn-link">{{ $trendingNews->title }}</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="https://docbao.qdnd.vn/readding">
                                            <img src="{{ url('/frontend') }}/img/ads-img/150x150_banner_baoin.jpg"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="col-sm-6">
                                        <a href="https://baomoi.com/chu-tich-ho-chi-minh/top/114.epi">
                                            <img src="{{ url('/frontend') }}/img/ads-img/150x150_banner_hcm_02-min.png"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="widget">
                            ...
                            <div class="list--widget list--widget-2" data-ajax-content="outer">
                                ...
                                <div class="post--items post--items-3">
                                    <ul class="nav" data-ajax-content="inner">
                                        @foreach ($sidebarComments as $comments)
                                            <li>
                                                <!-- Post Item Start -->
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <span class="thumb">
                                                            <img src="img/widgets-img/readers-opinion-01.png"
                                                                alt="">
                                                        </span>
                                                        <div class="post--info">
                                                            <div class="title">
                                                                <h3 class="h4">{{ $comments->noidung }}</h3>
                                                            </div>
                                                            <ul class="nav meta">
                                                                <li><span> by {{ $comments->commentUser->name }}</span>
                                                                </li>
                                                                <li><span>{{ $comments->ngaydang }}</span></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="widget">
                            ...
                            <div class="list--widget list--widget-1" data-ajax-content="outer">
                                ...
                                <div class="post--items post--items-3">
                                    <ul class="nav" data-ajax-content="inner">
                                        @foreach ($viewedNews as $viewedNews)
                                            <li>
                                                <!-- Post Item Start -->
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $viewedNews->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $viewedNews->hinhanh }}"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a
                                                                        href="#">{{ $viewedNews->tintucUser->name }}</a>
                                                                </li>
                                                                <li><a href="#">{{ $viewedNews->ngayduyet }}</a>
                                                                </li>
                                                            </ul>
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $viewedNews->slug]) }}"
                                                                        class="btn-link">{{ $viewedNews->title }}</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
