...
@section('main')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="post--video embed-responsive embed-responsive-16by9">
                                <iframe
                                    src="https://www.youtube.com/embed/aqz-KE-bpKQ?rel=0&amp;controls=0&amp;showinfo=0&amp;wmode=transparent"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="post--content">
                                <p>It is a long established fact that a reader will be distracted by the readable content of
                                    ...
                                    more-or-less normal making it look like readable english many desktop.</p>
                                <blockquote>
                    ...
                    <ul class="nav row">
                        <li class="col-md-3 col-xs-6 col-xxs-12 pbottom--30">
                            ...
                            <div class="info--block">
                                ...
                                <div class="content">
                                    <p>Aliquam quam laudantium suscipit ullam aut perferendis vel dicta blanditiis eligendi
                                        ratione consequatur, magni facilis dolor cupiditate et.</p>
                                </div>
                            </div>
                            <!-- Info Block End -->
                        </li>
    ...
    <div class="single-img--section ptop--30">
        <div class="container">
            <img src="{{ url('/frontend') }}/img/about-img/peoples.jpg" alt="" class="center-block">
        </div>
    </div>
