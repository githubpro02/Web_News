                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 ptop--30 pbottom--30">
                                ...
                                <div class="post--items-title" data-ajax="tab">
                                    <h2 class="h4">{{ $tintuc->count() }} {{ $title }} {{ $timeSecond }}</h2>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="post--img">
                                                                <a href="{{ route('bai-viet', ['slug' => $tintuc->slug]) }}"
                                                                    class="thumb"><img
                                                                        src="public/uploads/tintuc/{{ $tintuc->hinhanh }}"
                                                                        alt=""></a>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="post--info">
                                                                <ul class="nav meta">
                                                                    <li><a
                                                                            href="#">{{ $tintuc->tintucUser->name }}</a>
                                                                    </li>
                                                                    <li><a href="#">{{ $tintuc->ngayduyet }}</a></li>
                                                                    <li><span><i
                                                                                class="fa fm fa-eye"></i>{{ $tintuc->luotxem }}</span>
                                                                    </li>
                                                                </ul>
                                                                <div class="title">
