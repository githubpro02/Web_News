            ...
            <div class="main--content">
                ...
                <div class="post--items post--items-1 pd--30-0">
                    <div class="row gutter--15">
                        <div class="col-md-6">
                            <div class="row gutter--15">
                                @foreach ($taoMoiNhat as $taoMoiNhat)
                                    <div class="col-xs-6 col-xss-12">
                                        <!-- Post Item Start -->
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet', ['slug' => $taoMoiNhat->slug]) }}"
                                                    class="thumb"><img
                                                        src="/uploads/tintuc/{{ $taoMoiNhat->hinhanh }}"alt=""></a>
                                                <a href="{{ url('category/' . $taoMoiNhat->tintucCategory->slug) }}"
                                                    class="cat">{{ $taoMoiNhat->tintucCategory->title }}</a>
                                                <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                                <div class="post--info">
                                                    <ul class="nav meta">
                                                        @foreach ($user as $u)
                                                            @if ($u->id == $taoMoiNhat->tacgia)
                                                                <li><a href="#">{{ $u->name }}</a></li>
                                                            @endif
                                                        @endforeach
                                                        <li><a href="#">{{ $taoMoiNhat->ngayduyet }}</a></li>
                                                    </ul>
                                                    <div class="title">
                                                        <h2 class="h4"><a
                                                                href="{{ route('bai-viet', ['slug' => $taoMoiNhat->slug]) }}"
                                                                class="btn-link">{{ $taoMoiNhat->title }}</a></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                @foreach ($thoisuMoiNhat as $thoisuMoiNhat)
                                    <div class="col-sm-12 hidden-sm hidden-xs">
                                        <!-- Post Item Start -->
                                        <div class="post--item post--layout-1 post--title-larger">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet', ['slug' => $thoisuMoiNhat->slug]) }}"
                                                    class="thumb"><img src="/uploads/tintuc/{{ $thoisuMoiNhat->hinhanh }}"
                                                        style="height:200px" alt=""></a>
                                                <a href="{{ url('category/' . $taoMoiNhat->tintucCategory->slug) }}"
                                                    class="cat">{{ $thoisuMoiNhat->tintucCategory->title }}</a>
                                                <a href="#" class="icon"><i class="fa fa-fire"></i></a>
                                                <div class="post--info">
                                                    <ul class="nav meta">
                                                        @foreach ($user as $u)
                                                            @if ($u->id == $thoisuMoiNhat->tacgia)
                                                                <li><a href="#">{{ $u->name }}</a></li>
                                                            @endif
                                                        @endforeach
                                                        <li><a href="#">{{ $thoisuMoiNhat->ngayduyet }}</a></li>
                                                    </ul>
                                                    <div class="title">
                                                        <h2 class="h4"><a
                                                                href="{{ route('bai-viet', ['slug' => $thoisuMoiNhat->slug]) }}"
                                                                class="btn-link">{{ $thoisuMoiNhat->title }}</a></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6">
                            <!-- Post Item Start -->
                            @foreach ($nghethuatMoiNhat as $nghethuatMoiNhat)
                                <div class="post--item post--layout-1 post--title-larger">
                                    <div class="post--img">
                                        <a href="{{ route('bai-viet', ['slug' => $nghethuatMoiNhat->slug]) }}"
                                            class="thumb"><img src="/uploads/tintuc/{{ $nghethuatMoiNhat->hinhanh }}"
                                                alt=""></a>
                                        <a href="{{ url('category/' . $nghethuatMoiNhat->tintucCategory->slug) }}"
                                            class="cat">{{ $nghethuatMoiNhat->tintucCategory->title }}</a>
                                        <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                        <div class="post--map">
                                        ...
                                        <div class="post--info">
                                            <ul class="nav meta">
                                                @foreach ($user as $u)
                                                    @if ($u->id == $nghethuatMoiNhat->tacgia)
                                                        <li><a href="#">{{ $u->name }}</a></li>
                                                    @endif
                                                @endforeach
                                                <li><a href="#">{{ $nghethuatMoiNhat->ngayduyet }}</a></li>
                                            </ul>
                                            <div class="title">
                                                <h2 class="h4"><a
                                                        href="{{ route('bai-viet', ['slug' => $nghethuatMoiNhat->slug]) }}"
                                                        class="btn-link">{{ $nghethuatMoiNhat->title }}</a>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="nav row gutter--15" data-ajax-content="inner">
                                        @foreach ($the_gioi as $tg)
                                            <li class="col-xs-12">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $tg->slug]) }}"
                                                            class="thumb"><img src="/uploads/tintuc/{{ $tg->hinhanh }}"
                                                                alt=""></a>
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $tg->slug]) }}"
                                        ...
                                        @foreach ($the_gioi2 as $the_gioi2)
                                            <li class="col-xs-6">
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $the_gioi2->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $the_gioi2->hinhanh }}"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                @foreach ($user as $u)
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $the_gioi2->slug]) }}"
                                        ...
                                        @foreach ($the_gioi3 as $the_gioi3)
                                            <li class="col-xs-6">
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $the_gioi3->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $the_gioi3->hinhanh }}"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                @foreach ($user as $u)
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $the_gioi3->slug]) }}"
                                    ...
                                    <ul class="nav" data-ajax-content="inner">
                                        @foreach ($cong_nghe as $cong_nghe)
                                            <li>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $cong_nghe->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $cong_nghe->hinhanh }}"
                                                                alt=""></a>
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $cong_nghe->slug]) }}"
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $cong_nghe2->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $cong_nghe2->hinhanh }}"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                @foreach ($user as $u)
                                                                    ...
                                                                    @endif
                                                                @endforeach
                                                                <li><a href="#">{{ $cong_nghe2->ngayduyet }}</a>
                                                                </li>
                                                            </ul>
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $cong_nghe2->slug]) }}"
                                    ...
                                    <ul class="nav row" data-ajax-content="inner">
                                        @foreach ($giao_duc as $giao_duc)
                                            <li class="col-md-6">
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $giao_duc->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $giao_duc->hinhanh }}"
                                                                alt=""></a>
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $giao_duc->slug]) }}"
                                            ...
                                            <ul class="nav row">
                                                ...
                                                @foreach ($giao_duc2 as $giao_duc2)
                                                    <li class="col-xs-6">
                                                        ...
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img">
                                                                <a href="{{ route('bai-viet', ['slug' => $giao_duc2->slug]) }}"
                                                                    class="thumb"><img
                                                                        src="/uploads/tintuc/{{ $giao_duc2->hinhanh }}"
                                                                        alt=""></a>
                                                                <div class="post--info">
                                                                    <ul class="nav meta">
                                                                        @foreach ($user as $u)
                                                                    ...
                                                                    <div class="title">
                                                                        <h3 class="h4"><a
                                                                                ...
                                                                                class="btn-link">{{ $giao_duc2->title }}</a>
                                                                        </h3>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                @foreach ($giao_duc3 as $giao_duc3)
                                                    <li class="col-xs-6">
                                                        ...
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img">
                                                                <a href="{{ route('bai-viet', ['slug' => $giao_duc3->slug]) }}"
                                                                    class="thumb"><img
                                                                        src="/uploads/tintuc/{{ $giao_duc3->hinhanh }}"
                                                                        alt=""></a>
                                                                <div class="post--info">
                                                                    <ul class="nav meta">
                                                                        @foreach ($user as $u)
                                                                        ...
                                                                        @endforeach
                                                                        <li><a
                                                                                href="#">{{ $giao_duc3->ngayduyet }}</a>
                                                                        </li>
                                                                    </ul>
                                                                    <div class="title">
                                                                        <h3 class="h4"><a
                                                                                href="{{ route('bai-viet', ['slug' => $giao_duc3->slug]) }}"
                                                                                class="btn-link">{{ $giao_duc3->title }}</a>
                                                                        </h3>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <ul class="nav row gutter--15" data-ajax-content="inner">
                                        @foreach ($the_thao as $thethao)
                                            <li class="col-xs-12">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $thethao->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $thethao->hinhanh }}"
                                                                alt=""></a>
                                                        <a href="{{ url('properti/' . $thethao->tintucProperti->slug) }}"
                                                            class="cat">{{ $thethao->tintucProperti->title }}</a>
                                                        <a href="#" class="icon"><i class="fa fa-fire"></i></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                @foreach ($user as $u)
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $thethao->slug]) }}"
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $khoahoc->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $khoahoc->hinhanh }}"
                                                                alt=""></a>
                                                        <a href="{{ url('properti/' . $khoahoc->tintucProperti->slug) }}"
                                                            class="cat">{{ $khoahoc->tintucProperti->title }}</a>
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $khoahoc->slug]) }}"
                                ...
                                <div class="post--item post--layout-1 post--type-video post--title-large">
                                    <div class="post--img">
                                        <a href="{{ $video->video }}" class="thumb"><img
                                                src="/uploads/tintuc/{{ $video->hinhanh }}" alt=""></a>
                                        <a href="{{ url('properti/' . $video->tintucProperti->slug) }}"
                                            class="cat">{{ $video->tintucProperti->title }}</a>
                                        <a href="#" class="icon"><i class="fa fa-eye"></i></a>
                                        <div class="post--info">
                                            <ul class="nav meta">
                                                @foreach ($user as $u)
                                            ...
                                            <div class="title">
                                                <h2 class="h4"><a
                                                        href="{{ route('bai-viet', ['slug' => $video->slug]) }}"
                                    ...
                                    <ul class="nav" data-ajax-content="inner">
                                        @foreach ($doi_song as $doisong)
                                            <li>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $doisong->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $doisong->hinhanh }}"
                                                                alt=""></a>
                                                        <a href="{{ url('properti/' . $doisong->tintucProperti->slug) }}"
                                                            class="cat">{{ $doisong->tintucProperti->title }}</a>
                                                        <a href="#" class="icon"><i class="fa fa-star-o"></i></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                @foreach ($user as $u)
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $doisong->slug]) }}"
                                    ...
                                    <ul class="nav row gutter--15" data-ajax-content="inner">
                                        @foreach ($phap_luat as $phapluat)
                                            <li class="col-xs-12">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $phapluat->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $phapluat->hinhanh }}"
                                                                alt=""></a>
                                                        <a href="{{ url('properti/' . $phapluat->tintucProperti->slug) }}"
                                                            class="cat">{{ $phapluat->tintucProperti->title }}</a>
                                                        <a href="#" class="icon"><i
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $phapluat->slug]) }}"
                                    ...
                                    <ul class="nav row gutter--15" data-ajax-content="inner">
                                        @foreach ($giai_tri as $giaitri)
                                            <li class="col-md-4 col-xs-6 col-xxs-12">
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $giaitri->slug]) }}"
                                                            class="thumb"><img
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $giaitri->slug]) }}"
                                    ...
                                    <ul class="nav row gutter--15" data-ajax-content="inner">
                                        @foreach ($kinh_te as $kinhte)
                                            <li class="col-md-12">
                                                ...
                                                <div class="post--item post--layout-1 post--title-large">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $kinhte->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $kinhte->hinhanh }}"
                                                                alt=""></a>
                                                        <a href="{{ url('properti/' . $kinhte->tintucProperti->slug) }}"
                                                            class="cat">{{ $kinhte->tintucProperti->title }}</a>
                                                        <a href="#" class="icon"><i class="fa fa-eye"></i></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                @foreach ($user as $u)
                                                            ...
                                                            <div class="title text-xxs-ellipsis">
                                                                <h2 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $kinhte->slug]) }}"
