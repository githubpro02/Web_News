<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/home') }}" class="brand-link">
        <img src="{{ url('/backend') }}/dist/img/KCN.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
        ...
        <form action="{{ url('timkiembaiviet') }}" method="POST" data-widget="sidebar-search">
            ...
            <div class="form-inline">
                <div class="input-group">
                    <input class="form-control form-control-sidebar" name="search" type="search" placeholder="Search"
                        aria-label="Search">
