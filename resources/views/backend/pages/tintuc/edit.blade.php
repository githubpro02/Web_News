    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('tintuc.update', ['tintuc' => $tintuc->id]) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="examleInput" class="">Thuộc tính danh Mục <span style="color: red">
                                            *</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $tintuc->tag }}" name="tag"
                                    data-role="tagsinput">
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col">
                                    ...
                                    <img src="{{ URL::to('/uploads/tintuc/' . $tintuc->hinhanh) }}" width="100px"
                                        height="100px" alt="">
                                </div>
                                <hr>
                                <div class="col">
