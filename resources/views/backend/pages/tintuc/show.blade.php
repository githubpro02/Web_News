    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <img src="{{ URL::to('/uploads/tintuc/' . $tin->hinhanh) }}" width="100%" height="450px"
                        alt="">
                    <h4>{{ $tin->title }}</h4>
                    <span>
                        @foreach ($user as $u)
            ...
            @if (auth()->user()->hasRole(2) ||
                ...
                <div class="card-footer">
                    <button id="duyet" href="{{ route('duyet-bai', ['id' => $tin->id]) }}"
                        onclick="return confirm('bạn có chắc duyệt bài viết này không?')" type="submit" name="submit"
                        class="btn btn-primary">Duyệt</button>
                    <a href="{{ url('tuchoi/' . $tin->id) }}"
                        onclick="return confirm('bạn có chắc từ chối bài viết này không?')" type="submit" name="submit"
