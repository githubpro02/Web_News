                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($writer as $tin)
                                    <tr>
                                        <td>{{ $writer->firstItem() + $loop->index }}</td>
                                        <td>{{ $tin->title }}</td>
                                        <td>
                                            <p>
                                                @php
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('tintuc.show', ['tintuc' => $tin->id]) }}" type="button"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @if (isset($tintucShort))
                                    @foreach ($tintucShort as $tin)
                                        <tr>
                                            <td>{{ $tintucShort->firstItem() + $loop->index }}</td>
                                            <td>{{ $tin->title }}</td>
                                            <td>
                                                @foreach ($user as $u)
                                                    @if ($u->id == $tin->tacgia)
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('tintuc.show', ['tintuc' => $tin->id]) }}" type="button"
                                                        class="btn btn-info"><i class="fa fa-eye"></i></a>
                                                    <form action="{{ route('duyet-bai', ['id' => $tin->id]) }}" method="POST">
                                                        @csrf
                                                        <button type="submit" class="btn btn-success"><i
                                                                class="fa fa-check"></i></button>
                                                    </form>
                                                    <a href="{{ url('tuchoi/' . $tin->id) }}" type="button"
                                                        class="btn btn-danger xoa"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($tintucDuyet as $tin)
                                    <tr>
                                        <td>{{ $tintucDuyet->firstItem() + $loop->index }}</td>
                                        <td>{{ $tin->title }}</td>
                                        <td>
                                            @foreach ($user as $u)
                                                @if ($u->id == $tin->tacgia)
