        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('thuoctinhdanhmuc.create') }}" class="btn btn-success">Thêm thuộc tính danh mục
                        mới</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($properti as $pro)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('thuoctinhdanhmuc.edit', ['thuoctinhdanhmuc' => $pro->id]) }}"
                                                type="button" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                            <form
                                                action="{{ route('thuoctinhdanhmuc.destroy', ['thuoctinhdanhmuc' => $pro->id]) }}"
