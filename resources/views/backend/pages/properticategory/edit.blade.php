                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="title" value="{{ $properti->title }}"
                                        name="title" placeholder="Nhập tên thuộc tính" onkeyup="ChangeToSlug();">
                                </div>
                                <div class="col">
                                    <label for="exampleInputPassword1">Slug</label>
                                    <input type="text" class="form-control" id="slug" value="{{ $properti->slug }}"
                            ...
                            <div class="row">
                                ...
                                <select name="category" id="" class="form-control">
                                    ...
                                    @foreach ($category as $cat)
                                        <option
                                            value="{{ $cat->id }}"@if ($cat->id == $properti->id_category) selected @endif>
                                            {{ $cat->title }}</option>
                                    @endforeach
                                </select>
                            </div>
